...
where x, y, z and yaw, pitch, roll has to be specified. With the setup in our project they were: $\left[0.7, 0.8, 2.3, \frac{\pi}{2}, 0, \pi \right].$ This might need to be tweaked to get a good calibration.
...
\end{itemize} 
\item Set queue size to 0 everywhere
\end{itemize}
